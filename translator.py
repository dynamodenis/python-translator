...
class Translator_App(object):
    def __init__(self,master):
        ...
        tabControl.configure(width=900, height=900)
        
        self.translate_tab = ttk.Frame(tabControl)
        tabControl.add(self.translate_tab, text= "Word Dictionary with Pronounciation")
        tabControl.grid()
    ...
    def translate_page(self):
        ...
        self.word_entry = Entry(self.translate_tab, width=45)
        ...
        self.translate_button = Button(self.translate_tab,text="Translate!", command=self.translate_function)
